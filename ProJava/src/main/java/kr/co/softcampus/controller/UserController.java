...
public class UserController {
	...
	public String login(@ModelAttribute("tempLoginUserBean") UserBean tempLoginUserBean,
						...
						// "fail" key의 value를 받아서 boolean fail이라는 변수에 할당할 건데, 안 남어온다면 기본값은 false.
						// ModelAttribute와 마찬가지로, 동적으로 일단 생성한다. 
		
		model.addAttribute("fail", fail);	// boolean fail을 "fail"이라는 이름으로 Request 객체에 첨부한다. 
